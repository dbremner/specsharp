...
namespace Microsoft.Contracts{
  ...
  public sealed class NonNullType {
#if true // Remove once we revved the LKG
#if WHIDBEYwithGenerics
    [return:NotNull]
    ...
    public static T IsNonNullGeneric<T>([Delayed] T o) {
      if (null == default(T) && o == null) {
    ...
    [Reads(ReadsAttribute.Reads.Nothing)]
    [System.Diagnostics.DebuggerStepThrough]
    public static T IsNonNullImplicitGeneric<T>([Delayed] T o) {
      if (null == default(T) && o == null)
        throw new NullException();
      else
        return o;
    ...
    public static void AssertNotNullGeneric<T>([Delayed] T o) {
      if (null == default(T) && o == null) {
        throw new NullException();
      }
    }
    ...
    [System.Diagnostics.DebuggerStepThrough]
    [System.Diagnostics.Conditional("DEBUG")]
    public static void AssertNotNullImplicitGeneric<T>([Delayed] T o) {
      if (null == default(T) && o == null) {
        throw new NullException();
      }
    }
#else
    // These 2 methods are needed for Everett builds
    //
    public static object IsNonNull([Delayed] object o){
      if (o == null)
        throw new NullException();
      else
        return o;
    }
    public static object IsNonNullImplicit([Delayed] object o){
      if (o == null)
        throw new NullException();
      else
        return o;
    ...
    //[System.Diagnostics.Conditional("DEBUG")]
    /// <summary>
    /// Marks the commit point during array initialization of arrays with non-null elements type.
    /// </summary>
    public static void AssertInitialized([Delayed] object obj) {
      if (obj == null)
        throw new NullException();
      ...
      int n = arr.Length;
      for (int i = 0; i < n; i++) {
        if (arr[i] == null) throw new NullException();
      }
    }
    [Throws(typeof(System.NullReferenceException))]
    [Pure]
    ...
    [System.Diagnostics.DebuggerStepThrough]
    //[System.Diagnostics.Conditional("DEBUG")]
    public static void AssertInitialized<T>([Delayed] T[] arr) {
      if (null == default(T)) {
  ...
  public class AssertHelpers {
    ...
    [System.Diagnostics.DebuggerStepThrough]
    public static void Assert(bool b, SerializationInfo info, StreamingContext context) {
      if (!b)
        throw new Contracts.AssertException(info,context);
    }
    /// <summary>
    ...
    [System.Diagnostics.DebuggerStepThrough]
    public static void Assume(bool b, SerializationInfo info, StreamingContext context) {
      if (!b)
        throw new Contracts.AssumeException(info,context);
    }
    /// <summary>
    /// Is deserialized by Boogie.
    /// </summary>
  ...
  public class UnreachableException : Exception {
    ...
    public UnreachableException(SerializationInfo info, StreamingContext context) : base(info, context) { }
  }
  ...
  public class AssertException : ContractException {
    ...
    public AssertException(SerializationInfo info, StreamingContext context) : base(info,context) {}
  }
  public class LoopInvariantException : AssertException {
    ...
    public LoopInvariantException(SerializationInfo info, StreamingContext context) : base(info,context) {}
  }
  public class AssumeException : ContractException {
    ...
    public AssumeException(SerializationInfo info, StreamingContext context) : base(info,context) {}
  }
  /// <summary>
  ...
  public class InvalidContractException : ContractException {
    ...
    public InvalidContractException(SerializationInfo info, StreamingContext context) : base(info,context) {}
  }
  public class RequiresException : ContractException {
    ...
    public RequiresException(SerializationInfo info, StreamingContext context) : base(info,context) {}
  }
  public class EnsuresException : ContractException {
    ...
    public EnsuresException(SerializationInfo info, StreamingContext context) : base(info,context) {}
  }
  public class ModifiesException : ContractException {
    ...
    public ModifiesException(SerializationInfo info, StreamingContext context) : base(info,context) {}
  }
  public class ThrowsException : ContractException {
    ...
    public ThrowsException(SerializationInfo info, StreamingContext context) : base(info,context) {}
  }
  public class DoesException : ContractException {
    ...
    public DoesException(SerializationInfo info, StreamingContext context) : base(info,context) {}
  }
  ...
  public class NullException : ContractException {
    ...
    public NullException(SerializationInfo info, StreamingContext context) : base(info,context) {}
  }
  public class ModelfieldException : ContractException {
    public ModelfieldException(string s) : base("Not all satisfies clauses of model field " + s + " are satisified.") { }
  }
  public class ContractMarkerException : ContractException {
  }
  public class PreAllocatedExceptions {
    public static readonly UnreachableException Unreachable = new UnreachableException();
    public static readonly EnsuresException Ensures = new EnsuresException();
    public static readonly RequiresException Requires = new RequiresException();
    public static readonly InvalidContractException InvalidContract = new InvalidContractException();
    public static readonly ArgumentNullException ArgumentNull = new ArgumentNullException();
  }
  ...
  */
  ...
  public sealed class ReadsAttribute : Microsoft.Contracts.AttributeWithContext {
    public enum Reads { Nothing, Owned, Everything };
    private Reads whatIsRead;
    public ReadsAttribute() { this.whatIsRead = Reads.Owned; }
    public ReadsAttribute(Reads r) { this.whatIsRead = r; }
    public Reads WhatIsRead { get { return this.whatIsRead; } }
  }
  #region Diego's Attributes
  /// <summary>
  /// Used to indicate that a field is assignated only once
  /// </summary>
  ...
  /// <summary>
  /// To specify that the object referred by the parameter only can write the object it owns. 
  /// WriteConfined for a method means all parameters are write confined.
  /// </summary>
  [AttributeUsage(SpecTargets.Code | AttributeTargets.Field | AttributeTargets.Parameter, AllowMultiple = true, Inherited = true)]
  public sealed class WriteConfinedAttribute: AttributeWithContext{
      public bool Value;
        public WriteConfinedAttribute()
        {
            Value = true;
        }
        public WriteConfinedAttribute(bool value)
        {
            this.Value = value;
        }
  }
  ...
  public sealed class GlobalWriteAttribute: AttributeWithContext{
      public bool Value;
      public GlobalWriteAttribute()
      {
          Value = true;
      }
      public GlobalWriteAttribute(bool value)
      {
          this.Value = value;
      }
  ...
  public sealed class GlobalReadAttribute: AttributeWithContext{
      public bool Value;
      public GlobalReadAttribute()
      {
          Value = false;
      }
      public GlobalReadAttribute(bool value)
      {
          this.Value = value;
      }
    ...
    {
        public bool Value;
        public GlobalAccessAttribute()
        {
            Value = true;
        }
        public GlobalAccessAttribute(bool value)
        {
            this.Value = value;
        }
   ...
   [AttributeUsage(SpecTargets.Code | AttributeTargets.ReturnValue | AttributeTargets.Field | AttributeTargets.Parameter, AllowMultiple = true, Inherited = true)]
    public sealed class ReadAttribute : AttributeWithContext
    {
       public bool Value;
        ...
        public ReadAttribute(bool value)
        {
            this.Value = value;
        }
    }
    [AttributeUsage(SpecTargets.Code |  AttributeTargets.Field | AttributeTargets.Parameter, AllowMultiple = true, Inherited = true)]
    public sealed class WriteAttribute : AttributeWithContext
    {
        public bool Value;
        ...
        public WriteAttribute(bool value)
        {
            this.Value = value;
        }
    }
  ...
  #endregion Diego's Attributes

  [Obsolete("Use [Pure] and [Reads(ReadsAttribute.Reads.Nothing)] instead")]
  [AttributeUsage(SpecTargets.Code, AllowMultiple = false, Inherited = true)]
  ...
  [AttributeUsage(AttributeTargets.ReturnValue | AttributeTargets.Field | AttributeTargets.Parameter, AllowMultiple = true, Inherited = false)]
  public sealed class NotNullArrayElementsAttribute : AttributeWithContext {
  }
  ...
  public sealed class WitnessAttribute : AttributeWithContext {
    public bool IsNotUpperbound;
    public int NrOfDuplicates;
    public string Witness;
    public string Guard;
    public string Modelfield; //null if this is a witness for a pure method.
    public WitnessAttribute(string _witness) {this.Witness = _witness;} //Depracated
    public WitnessAttribute(bool _isNotUpperbound, int _nrOfDups, string _guard, string _witness) {
      this.IsNotUpperbound = _isNotUpperbound; this.NrOfDuplicates = _nrOfDups; this.Witness = _witness; this.Guard = _guard;
    }
    public WitnessAttribute(bool _isNotUpperbound, int _nrOfDups, string _guard, string _witness, string _mf) :
      this(_isNotUpperbound, _nrOfDups, _guard, _witness) {
      this.Modelfield = _mf;
    }
  }
  ...
  public sealed class ThrowsAttribute: AttributeWithContext{
    ...
    // for "throws E ensures Q;" or "throws (E e) ensures Q;"
    public ThrowsAttribute (Type exceptionType, string _ensures){
      ExceptionType = exceptionType;
      Condition = _ensures;
    }
  }
  ...
  #region Attributes related to modelfields
  
  [AttributeUsage(SpecTargets.Containers, AllowMultiple = false, Inherited = true)]
  public sealed class ModelfieldContractAttribute : AttributeWithContext {
    public string Modelfield;
    public string Witness;

    public ModelfieldContractAttribute(string _modelfield, string _witness) {
  ...
  [AttributeUsage(SpecTargets.Containers, AllowMultiple = true, Inherited = true)]
  public sealed class SatisfiesAttribute : AttributeWithContext {
    public string Modelfield;
    public string Satisfies;

    public SatisfiesAttribute(string _modelfield, string _satisfies) {
      Modelfield = _modelfield;
  ...
  [AttributeUsage(SpecTargets.CodeFieldsAndTheirContainers, AllowMultiple = false, Inherited = true)]
  public sealed class ModelfieldAttribute : Attribute { } //indicates that a Field is a modelfield
...
namespace System.Compiler {
  ...
  /// <summary>
  /// This attribute marks a template parameter T as being instantiable only with pointerfree structs
  /// thereby allowing overlays of pointerfree memory blocks in generic contexts
  /// It needs to be present under Everett and Whidbey, since MSIL 2.0 does not have a way to encode
  /// this AFAIK. [MAF 5/13/07]
  /// </summary>
  [AttributeUsage(AttributeTargets.Class | AttributeTargets.Interface | AttributeTargets.Struct)]
  public sealed class PointerFreeStructTemplateParameterAttribute : System.Attribute
  {
  }
...
namespace Microsoft.Contracts{
  ...
  /// <summary>
  /// A marker interface that indicates that the class that implements it must be immutable. Useful when requiring that any object implementing
  /// a non immutable interface such as IEnumerable, must in fact be immutable.
  /// </summary>
  [Immutable]
  ...
  [AttributeUsage(SpecTargets.Code,AllowMultiple=false, Inherited = true)]
  [Obsolete("Use [Pure] and [Reads(ReadsAttribute.Reads.Owned)] instead")]
  ...
  public sealed class ElementsRepAttribute : AttributeWithContext {
      public int Value; 
      public ElementsRepAttribute() { this.Value = -1; }
      public ElementsRepAttribute(int value) { this.Value = value; }
  }
  /// <summary>
  ...
  public sealed class ElementsPeerAttribute : AttributeWithContext {
      public int Value; 
      public ElementsPeerAttribute() { this.Value = -1; }
      public ElementsPeerAttribute(int value) { this.Value = value; }
  }
  /// <summary>
  ...
  public sealed class Owner{
    ...
    /// The following methods yield the element owner of an array or generic class instance.
      [Pure]
      [ResultNotNewlyAllocated]
      [return:NotNull]
    public static object ElementProxy([NotNull] [Delayed] object c) { return c; }
      [Pure]
      [ResultNotNewlyAllocated]
      [return:NotNull]
    public static object ElementProxy([NotNull] [Delayed] object c, int pos) { return c; }
}
