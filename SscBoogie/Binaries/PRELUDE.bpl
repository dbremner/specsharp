...
axiom (∀h: HeapType • { IsPreHeap(h) }  IsHeap(h) ⇒ IsPreHeap(h));
...
axiom (∀ T: TName •  { $BaseClass(T) }  T <: $BaseClass(T) ∧  (¬$IsValueType(T) ∧ T ≠ System.Object ⇒ T ≠ $BaseClass(T)));
...
axiom (∀ T: TName •  T <: System.Object ⇒ ¬$IsValueType(T));
